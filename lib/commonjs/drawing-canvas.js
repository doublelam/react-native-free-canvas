...
const DrawingCanvas = /*#__PURE__*/(0, _react.forwardRef)(({
  ...
  const pathBuilderSharedVal = (0, _reactNativeReanimated.useSharedValue)(_reactNativeSkia.Skia.PathBuilder.Make());
  ...
  const derivedPathSharedVal = (0, _reactNativeReanimated.useDerivedValue)(() => pathBuilderSharedVal.value.build().toSVGString(), []);
  ...
  .averageTouches(true).onStart(e => {
    ...
    (0, _reactNativeWorklets.scheduleOnRN)(changeDrawing, false);
  }).onUpdate(e => {
    'worklet';
    ...
    (0, _reactNativeWorklets.scheduleOnRN)(changeDrawing, true);
    (0, _reactNativeWorklets.scheduleOnRN)(addDrawn, {
